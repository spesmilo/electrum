...
APPDIR="$BUILDDIR/electrum-vault.AppDir"
...
APPIMAGE="$DISTDIR/electrum-vault-$VERSION-x86_64.AppImage"
...
cp "$PROJECT_ROOT/electrum.desktop" "$APPDIR/electrum-vault.desktop"
