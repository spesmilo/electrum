...
APPDIR="$BUILDDIR/defichain-electrum.AppDir"
...
APPIMAGE="$DISTDIR/defichain-electrum-$VERSION-x86_64.AppImage"
...
cp "$PROJECT_ROOT/electrum.desktop" "$APPDIR/defichain-electrum.desktop"
cp "$PROJECT_ROOT/electrum/gui/icons/defichain_logo.png" "$APPDIR/electrum.png"
