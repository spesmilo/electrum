...
datas = [
    ...
    (electrum + 'electrum_plugins', 'electrum_plugins'),
]
...
a = Analysis([electrum+MAIN_SCRIPT,
              ...
              electrum+'electrum_plugins/cosigner_pool/qt.py',
              electrum+'electrum_plugins/email_requests/qt.py',
              electrum+'electrum_plugins/trezor/client.py',
              electrum+'electrum_plugins/trezor/qt.py',
              electrum+'electrum_plugins/keepkey/qt.py',
              electrum+'electrum_plugins/ledger/qt.py',
              ],
             binaries=binaries,
             datas=datas,
