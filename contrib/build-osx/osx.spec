...
datas = [
    (electrum+'electrum/lib/*.json', PYPKG),
...
a = Analysis([electrum+ MAIN_SCRIPT,
              ...
              electrum+'electrum/lib/util.py',
              electrum+'electrum/lib/wallet.py',
              electrum+'electrum/lib/simple_config.py',
              electrum+'electrum/lib/bitcoin.py',
              electrum+'electrum/lib/dnssec.py',
              electrum+'electrum/lib/commands.py',
