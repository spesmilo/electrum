...
if [ ! -f "$DLL_TARGET_DIR/libZXing.dylib" ]; then
    ...
    # The system Xcode 13 toolchain lacks the C++20 library support required by ZXing.
    # Keep the newer compiler scoped to this C API library, with its runtimes bundled.
