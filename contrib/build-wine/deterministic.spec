...
datas = [
    (home+'electrum/lib/*.json', 'electrum/lib'),
...
a = Analysis([home+'run_electrum',
              ...
              home+'electrum/lib/util.py',
              home+'electrum/lib/wallet.py',
              home+'electrum/lib/simple_config.py',
              home+'electrum/lib/bitcoin.py',
              home+'electrum/lib/dnssec.py',
              home+'electrum/lib/commands.py',
