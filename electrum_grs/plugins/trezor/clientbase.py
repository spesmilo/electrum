...
from electrum_grs.util import PrintError, UserCancelled, UserFacingException
from electrum_grs.keystore import bip39_normalize_passphrase
from electrum_grs.bip32 import serialize_xpub, convert_bip32_path_to_list_of_uint32 as parse_path
...
class TrezorClientBase(PrintError):
    ...
    def has_usable_connection_with_device(self):
        ...
        try:
            res = self.client.ping("electrum-grs pinging device")
