...
class TestUtil(ElectrumTestCase):
    ...
    def test_parse_URI_invalid_address(self):
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'groestlcoin:invalidaddress')

    def test_parse_URI_invalid(self):
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'notgroestlcoin:FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9')

    def test_parse_URI_parameter_pollution(self):
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'groestlcoin:FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9?amount=0.0003&label=test&amount=30.0')
    ...
    def test_parse_URI_lightning_consistency(self):
        ...
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'groestlcoin:tgrs1qvu0c9xme0ul3gzx4nzqdgxsu25acuk9wvsj2j2?amount=0.0007&message=test266&lightning=')
        # bip21 uri that includes "lightning" key. top-level amount mismatches LN amount
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'groestlcoin:tgrs1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0008&message=test266&lightning=')
        # bip21 uri that includes "lightning" key with garbage unparseable value
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'groestlcoin:tgrs1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0008&message=test266&lightning=lntb700u1p3kqy26pp5l7rj7w0u5sdsj24umzdlhdasdasdasdasd')
