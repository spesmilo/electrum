...
#Factory.register('InfoBubble', module='electrum_grs.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_grs.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_grs.gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='electrum_grs.gui.kivy.uix.screens')
...
from electrum_grs.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def show_pr_details(self, req, status, is_invoice):
        ...
        fund = req.get('fund')
        popup = Builder.load_file('electrum_grs/gui/kivy/uix/ui_screens/invoice.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_grs.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_grs.gui.kivy.uix.qrcodewidget')
