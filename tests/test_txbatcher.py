...
from electrum.fee_policy import FeeTimeEstimates, FeePolicy
...
class TestTxBatcher(ElectrumTestCase):
    ...
    def setUp(self):
        ...
        self.fee_policy = FeePolicy('feerate:5000')
    ...
    async def test_batch_payments(self, mock_save_db):
        ...
        wallet.txbatcher.add_payment_output('default', output1, self.fee_policy)
        ...
        wallet.txbatcher.add_payment_output('default', output2, self.fee_policy)
    ...
    async def test_sweep_from_submarine_swap(self, mock_save_db):
        ...
        wallet.txbatcher.add_sweep_input('swaps', sweep_info, self.fee_policy)
        ...
        output1 = PartialTxOutput.from_address_and_value("tb1qyfnv3y866ufedugxxxfksyratv4pz3h78g9dad", 20_000)
        wallet.txbatcher.add_payment_output('swaps', output1, self.fee_policy)
