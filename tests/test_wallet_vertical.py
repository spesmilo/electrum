...
class TestWalletSending(ElectrumTestCase):
    ...
    async def test_sending_between_p2wpkh_and_compressed_p2pkh(self, mock_save_db):
        ...
        tx = wallet1.create_transaction(outputs=outputs, fee_policy=FixedFeePolicy(5000), tx_version=1, rbf=False)
        ...
        tx = wallet2.create_transaction(outputs=outputs, fee_policy=FixedFeePolicy(5000), tx_version=1, rbf=False)
    ...
    async def test_sending_between_p2sh_2of3_and_uncompressed_p2pkh(self, mock_save_db):
        ...
        tx = wallet1a.create_transaction(outputs=outputs, fee_policy=FixedFeePolicy(5000), tx_version=1, rbf=False)
    ...
    async def test_sending_between_p2wsh_2of3_and_p2wsh_p2sh_2of2(self, mock_save_db):
        ...
        # wallet2 -> wallet1
        outputs = [PartialTxOutput.from_address_and_value(wallet1a.get_receiving_address(), 100000)]
        tx = wallet2a.create_transaction(outputs=outputs, fee_policy=FixedFeePolicy(5000), tx_version=1, rbf=False)
    ...
    async def test_coinjoin_between_two_p2wpkh_electrum_seeds(self, mock_save_db):
        ...
        tx1 = wallet1.create_transaction(outputs=outputs, fee_policy=FixedFeePolicy(5000), tx_version=2, rbf=True)
        ...
        tx2 = wallet2.create_transaction(outputs=outputs, fee_policy=FixedFeePolicy(5000), tx_version=2, rbf=True)
...
class TestWalletOfflineSigning(ElectrumTestCase):
    ...
    async def test_sending_offline_old_electrum_seed_online_mpk(self, mock_save_db):
        ...
        tx = wallet_online.create_transaction(outputs=outputs, fee_policy=FixedFeePolicy(5000), rbf=True)
        tx.locktime = 1446655
        tx.version = 1
