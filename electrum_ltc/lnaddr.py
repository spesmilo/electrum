...
class LnAddr(object):
    ...
    def amount(self, value):
        ...
        if value.is_nan() or not (0 <= value <= TOTAL_COIN_SUPPLY_LIMIT_IN_BTC):
            raise LnAddressError(f"amount is out-of-bounds: {value!r} LTC")
        if value * 10**12 % 10:
...
if __name__ == '__main__':
    # run using
    # python3 -m electrum_ltc.lnaddr <invoice> <expected hrp>
    # python3 -m electrum_ltc.lnaddr  tb1n
    import sys
