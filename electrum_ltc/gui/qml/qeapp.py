...
from electrum_ltc.logging import Logger, get_logger
...
class ElectrumQmlApplication(QGuiApplication):
    ...
    def __init__(self, args, config, daemon, plugins):
        ...
        qmlRegisterType(QEQRParser, 'org.electrum_ltc', 1, 0, 'QRParser')
        qmlRegisterType(QEFX, 'org.electrum_ltc', 1, 0, 'FX')
        qmlRegisterType(QETxFinalizer, 'org.electrum_ltc', 1, 0, 'TxFinalizer')
        qmlRegisterType(QEInvoice, 'org.electrum_ltc', 1, 0, 'Invoice')
        qmlRegisterType(QEInvoiceParser, 'org.electrum_ltc', 1, 0, 'InvoiceParser')
        qmlRegisterType(QEUserEnteredPayment, 'org.electrum_ltc', 1, 0, 'UserEnteredPayment')
        qmlRegisterType(QEAddressDetails, 'org.electrum_ltc', 1, 0, 'AddressDetails')
        qmlRegisterType(QETxDetails, 'org.electrum_ltc', 1, 0, 'TxDetails')
        qmlRegisterType(QEChannelOpener, 'org.electrum_ltc', 1, 0, 'ChannelOpener')
        ...
        qmlRegisterType(QETxFeeBumper, 'org.electrum_ltc', 1, 0, 'TxFeeBumper')

        qmlRegisterUncreatableType(QEAmount, 'org.electrum_ltc', 1, 0, 'Amount', 'Amount can only be used as property')
        qmlRegisterUncreatableType(QENewWalletWizard, 'org.electrum_ltc', 1, 0, 'NewWalletWizard', 'NewWalletWizard can only be used as property')
        qmlRegisterUncreatableType(QEServerConnectWizard, 'org.electrum_ltc', 1, 0, 'ServerConnectWizard', 'ServerConnectWizard can only be used as property')
        ...
        not_loaded = QFontDatabase.addApplicationFont('electrum_ltc/gui/qml/fonts/PTMono-Regular.ttf') < 0
        not_loaded = QFontDatabase.addApplicationFont('electrum_ltc/gui/qml/fonts/PTMono-Bold.ttf') < 0 and not_loaded
        if not_loaded:
