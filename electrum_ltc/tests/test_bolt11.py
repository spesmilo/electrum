...
class TestBolt11(ElectrumTestCase):
    ...
    def test_roundtrip(self):
        ...
        tests = [
            ...
            LnAddr(paymenthash=RHASH, amount=24, tags=[('f', 'ltc1qw508d6qejxtdg4y5r3zarvary0c5xw7kgmn4n9'), ('h', longdescription)]),
            LnAddr(paymenthash=RHASH, amount=24, tags=[('f', 'ltc1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3qmu8tk5'), ('h', longdescription)]),
