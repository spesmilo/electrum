...
def encode_fallback(fallback, currency):
    ...
    """
    if currency in [constants.SyscoinMainnet.SEGWIT_HRP, constants.SyscoinTestnet.SEGWIT_HRP, constants.BitcoinMainnet.SEGWIT_HRP, constants.BitcoinTestnet.SEGWIT_HRP]:
