...
echo "Pulling 'electrum' libs into project from ../lib ..."
...
echo ""
python3 -m pbxproj flag iOS/Electrum.xcodeproj/project.pbxproj -- HEADER_SEARCH_PATHS '"$(SDK_DIR)"/usr/include/libxml2'
if [ "$?" != 0 ]; then
