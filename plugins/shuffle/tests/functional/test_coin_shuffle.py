...
class TestRound(unittest.TestCase):
    ...
    def test_003_process_equivocation_check(self):
        ...
        self.assertTrue(self.logchan.get(timeout=0), "Player 1 send transction signatures")
        self.assertTrue(self.logchan.empty())
    ...
    def test_004_process_verification_and_submission(self):
        ...
        self.assertEquals(self.logchan.get(timeout=0),"Player 1 got transction signatures")
