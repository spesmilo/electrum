...
fullname = _('Revealer')
description = ''.join([
    _("<br/><b>Do you have something to hide ?</b>"), '<br/>', '<br/>',
    ...
    _("Using a revealer is a better than writing your seed phrases on paper: a revealer is invulnerable to physical access and allows creation of trustless redundancy."), '<br/>', '<br/>',
