...
class LNWallet(LNWorker):
    ...
    def start_network(self, network: 'Network'):
        ...
        if (not self.swap_manager.use_nostr) or self.config.NOSTR_SWAPSERVER_PUBKEY or self.swap_manager.is_server:
    ...
    async def stop(self):
        ...
        if self.lnwatcher:
            ...
            self.lnwatcher = None
        if self.swap_manager and self.swap_manager.network_started:  # may not be present in tests
