...
class LNWallet(LNWorker):
    ...
    def __init__(self, wallet: 'Abstract_Wallet', xprv):
        ...
        self.pending_sent_htlcs = defaultdict(asyncio.Queue)  # type: Dict[bytes, asyncio.Future[BarePaymentAttemptLog]]
    ...
    async def _pay(
        ...
        while True:
            ...
            if htlc_log.sender_idx:
                ...
                if code == OnionFailureCode.MPP_TIMEOUT:
                    ...
                    short_channel_id = htlc_log.short_channel_id
        ...
        if success:
            ...
            #self.payment_failed(payment_hash)
