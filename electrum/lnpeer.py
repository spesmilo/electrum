...
class Peer(Logger, EventListener):
    ...
    def _check_unfulfilled_htlc_set(
        ...
        # If the set contains outer onions with different payment secrets the sets payment_key is
        ...
        if mpp_set.resolution == RecvMPPResolution.WAITING:
            ...
            # is a trampoline payment + we_are_final + payment key is derived from outer onions payment secret
