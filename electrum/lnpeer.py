...
class Peer(Logger, EventListener):
    ...
    def on_query_htlc_history(self, chan, payload):
        ...
        htlc_history, checkpoint = chan.hm.get_htlc_history(-proposer, None, index)
        local_first_hash, local_delta_msat = chan.hm.get_checkpoint(-proposer, LOCAL, checkpoint)
        remote_first_hash, remote_delta_msat = chan.hm.get_checkpoint(-proposer, REMOTE, checkpoint)
        # flip hashes
