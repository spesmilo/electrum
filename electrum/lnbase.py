...
class Peer(PrintError):
    ...
    def send_message(self, message_name: str, **kwargs):
        ...
        self.transport.send_bytes(lnserializer.gen_msg(message_name, **kwargs))
    ...
    def process_message(self, message):
        message_type, payload = lnserializer.decode_msg(message)
        try:
    ...
    def send_announcement_signatures(self, chan: Channel):
        ...
        chan_ann = lnserializer.gen_msg("channel_announcement",
            len=0,
            #features not set (defaults to zeros)
            chain_hash=constants.net.rev_genesis_bytes(),
            short_channel_id=chan.short_channel_id,
    ...
    async def _handle_error_code_from_failed_htlc(self, error_reason, route: List['RouteEdge'], channel_id, htlc_id):
        ...
        if offset:
            ...
            message_type, payload = lnserializer.decode_msg(channel_update)
            try:
