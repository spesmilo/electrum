...
from electrum.transaction import Transaction, int_to_hex
from electrum.address import Address, AddressError
...
class CoinUtils(PrintError):
    ...
    def check_inputs_for_sufficient_funds_and_return_total(self, inputs, amount):
        ...
        try:
            ...
            #import traceback
            #traceback.print_exc()
            self.logger.error("check_inputs_for_sufficient_funds: ", repr(e))
        return None, None
    ...
    def make_unsigned_transaction(self, amount, fee, all_inputs, outputs, changes):
        ...
        try:
            ...
            self.logger.error('make_unsigned_transaction:', repr(e))
            return None
    ...
    def verify_signature(self, signature, message, verification_key):
        ...
        try:
            ...
            self.logger.error("verify_signature:", repr(e))
            return False
