...
ElDialog {
    ...
    iconSource: Qt.resolvedUrl('../trustedcoin-status.png')
    ...
    function signAndBroadcast() {
        ...
        plugin.signAndBroadcast(psbt, password)
        dialog.close()
    }
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            Label {
                Layout.fillWidth: true
                wrapMode: Text.Wrap
                text: qsTr('This transaction was created by a wallet that this device cosigns for.')
            }
        ...
        DialogButtonContainer {
            ...
            FlatButton {
                ...
                icon.source: Qt.resolvedUrl('../../../gui/icons/key.png')
