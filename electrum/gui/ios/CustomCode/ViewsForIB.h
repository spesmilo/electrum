...
@property (nonatomic, weak) IBOutlet UILabel *compatModeTit, *walletNameTit, *walletPw1Tit, *walletPw2Tit, *errMsg, *touchIdTit;
@property (nonatomic, weak) IBOutlet UISwitch *touchId;
@property (nonatomic, weak) IBOutlet UISegmentedControl *compatMode;
