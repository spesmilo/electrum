...
class TestTransaction(unittest.TestCase):
    ...
    def test_tx_unsigned(self):
        expected = {
            'inputs': [{
                'type': 'p2pkh',
                'address': 'FYDpFNnMaaon5rhnW3JPZ2poqgZdSA4R22',
                'num_sig': 1,
            ...
            'lockTime': 0,
            'outputs': [{
                'address': 'FYMzzVJZYDz7GZ5vAHp8fsSAMdFVT5xsvX',
                'prevout_n': 0,
        ...
        self.assertEqual(tx.get_outputs(), [('FYMzzVJZYDz7GZ5vAHp8fsSAMdFVT5xsvX', 1000000)])
        self.assertEqual(tx.get_output_addresses(), ['FYMzzVJZYDz7GZ5vAHp8fsSAMdFVT5xsvX'])

        self.assertTrue(tx.has_address('FYMzzVJZYDz7GZ5vAHp8fsSAMdFVT5xsvX'))
        self.assertTrue(tx.has_address('FYDpFNnMaaon5rhnW3JPZ2poqgZdSA4R22'))
        self.assertFalse(tx.has_address('FgaSSzhNvc1kjR94Lz1c7K1L4rZdpae3Em'))
    ...
    def test_parse_xpub(self):
        ...
        self.assertEqual(res, ('04ee98d63800824486a1cf5b4376f2f574d86e0a3009a6448105703453f3368e8e1d8d090aaecdd626a45cc49876709a3bbb6dc96a4311b3cac03e225df5f63dfc', 'FdrrVxNSCD29XjHePDFaXvAxgUnru9ZnGk'))
