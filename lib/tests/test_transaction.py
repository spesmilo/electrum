...
class TestTransaction(unittest.TestCase):
    ...
    def test_txid_segwit_coinbase_to_p2sh(self):
        tx = transaction.Transaction('')
        self.assertEqual('e28ee5866ec0535fe5efac5ad350cbf4960ed981b471a0c4a6baad1d8168d3d7', tx.txid())
